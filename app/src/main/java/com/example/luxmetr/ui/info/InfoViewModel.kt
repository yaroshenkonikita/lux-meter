...
class InfoViewModel : ViewModel() {
    ...
    private val _features = MutableLiveData<String>().apply {
        value = """
            ...
            - Выбор типа помещения: Возможность выбора типа помещения (например, гостиная, спальня, офис, кухня), что позволяет более точно оценить состояние освещенности.
            - Обозначение состояния освещенности: Приложение отображает текущее состояние освещенности (ярко, нормально, тускло) в зависимости от выбранного типа помещения.
        """.trimIndent()
    }
    ...
    private val _interfaceDescription = MutableLiveData<String>().apply {
        value = """
            ...
            - Экран выбора помещения: На экране выбора помещения можно выбрать тип помещения, чтобы приложение могло точно отображать состояние освещенности.
        """.trimIndent()
    }
    ...
    private val _technicalDetails = MutableLiveData<String>().apply {
        value = """
            ...
            - Обозначение состояния освещенности: В зависимости от выбранного типа помещения и текущего уровня освещенности приложение отображает состояние освещенности (ярко, нормально, тускло).
        """.trimIndent()
    }
